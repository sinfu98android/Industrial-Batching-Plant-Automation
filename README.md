...
Built Orchestrix framework from scratch. Collaborated with machine manufacturer to implement and commission a fully functional batching plant system<br>
